...
const SocialLoginButtons = () => {
    ...
    return (
        <div className="absolute top-[640px] left-10 sm:left-[100px] mx-auto sm:w-[520px] w-full sm:h-[56px] h-auto flex flex-col sm:flex-row justify-center gap-4 opacity-100">
            <button
