function WelcomeCard(){
    return (
        ...
        tablet:w-[656px] tablet:h-[258px] tablet:px-[68px] tablet:py-[27px]">
            ...
            <button className="flex justify-center items-center p-[12px] text-[15px] font-bold  w-[118px] h-[36px] rounded-[30px] border tablet:text-[16px] tablet:w-[240px] tablet:h-[48px] tablet:self-start hover:border-[#268FE4]">Get Started</button>
        </div>
    );
}
