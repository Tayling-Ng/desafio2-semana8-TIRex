...
function Section3(){
    return(
        ...
        <div className="bg-[#5C5A79] w-[393px] h-[1270px] pt-[60px]">
            <div className="flex flex-col justify-center items-center gap-[24px] mb-[60px] ">
                <h2 className="text-[#FCF4B6] text-[25px] leading-[48px] font-bold">Featured Tools</h2>
                <p className="text-white text-[14px] leading-[24px] font-normal">Tools to enhance your project management</p>
                <button className="flex justify-center items-center bg-white text-[#160A60] w-[148px] h-[36px] p-[12px] font-medium text-[15px] leading-[24px] rounded-[8px]">View All</button>
            </div>
