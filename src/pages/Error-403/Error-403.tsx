...
const Error403 = () => {
  return (
    <div className='h-full flex flex-col gap-[48px] justify-center items-center tablet:flex-row tablet:gap-[33px]'>
      ...
      <p className='text-[18px] font-normal leading-[36px] w-[254px] text-center tablet:w-[387px] tablet:text-start tablet:text-[24px] desktop:w-[440px] '>Nothing to see here... yet! To see this content, you need to<Link to='/' className='underline text-[#4f46e5] font-bold'> log in.</Link> </p>
      </div>
    </div>
  )
}
